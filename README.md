...
The objective is to identify the key financial drivers of corporate distress while maintaining model transparency, which is critical in regulated banking and credit-risk environments.

The analysis prioritises financial reasoning and explainability over algorithmic complexity.
...
Bankrupt firm recall: ~75%

Precision for bankrupt firms: lower by design due to recall prioritisation
